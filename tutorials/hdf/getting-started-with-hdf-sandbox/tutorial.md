...
<<<<<<< HEAD
Login using [shell web client](http://sandbox-hdf.hortonworks.com:4200) and execute: `sandbox-version`. The output should look something like:
=======
...
>>>>>>> 2d409ee273f35d3022e183ed34ac8dd58fbceddd
